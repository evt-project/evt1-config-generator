...
export class EvtConfigService {
  ...
  constructor() {
    ...
    this.defaultConfigs.advanced.evtTxt = `<p>EVT (Edition Visualization Technology) is a software for creating and browsing
      ...
      This tool was born as part of the DVB (Digital Vercelli Book) project in order to allow the creation
      of a digital edition of the Vercelli Book, a parchment codex of the late tenth century, now preserved
      in the Archivio e Biblioteca Capitolare of Vercelli and regarded as one of the four most important
      manuscripts of the Anglo-Saxon period as regards the transmission of poetic texts in the Old English language.
    </p>
  ...
  getProperty(sectionName: string, propertyName: string) {
