...
import { AutoGeneratedContentConfigComponent } from './components/auto-generated-content-config/auto-generated-content-config.component';
import { XPathExpressionsConfigComponent } from './components/x-path-expressions-config/x-path-expressions-config.component';
...
@NgModule({
  declarations: [
    ...
    AutoGeneratedContentConfigComponent,
    XPathExpressionsConfigComponent,
  ],
  imports: [
    BrowserModule,
    HttpClientModule,
